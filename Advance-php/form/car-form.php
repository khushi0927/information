...
<body>
  ...
  <form method="post" >  
    ...
    <input type="text" name="car-name" class="border-success" required>
  </div>

  <div class="card-body text-success">
    <Label>Car Model :</Label>
    <input type="text" name="car-model" class="border-success " required>
  </div>

  <div class="card-body text-success ">
    <Label>Car Year :</Label>
    <input type="text" name="car-year" class="border-success " required>
  </div>
...
<?php
  ...
  {
    $car = new car();
    $car->brand = $_POST['car-name'];
    $car->model = $_POST['car-model'];
    $car->year = $_POST['car-year'];
    $car->display();
  }
?>
